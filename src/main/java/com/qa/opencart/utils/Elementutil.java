...
public class Elementutil {
	...
	// added first
	@Step("Sending the Value:{1}  to the Locators :{0}")
	...
	// added second
		@Step("Clicking on the element locator: {0}")
...
//		}
	...
	// now replace all the methods which we created with the below method.
		...
		//method for highlight which is calling highlight method from driverfactroy
	...
	//*********************** Explictly wait ***************************
		 ...
		 * @return
		 */
		@Step("Wating for the webelement using Locator:{0} and Timeouts:{1}")
